...
with import ../../../support.nix { inherit lib config; }; {
  ...
  home-manager.users.sencho.xdg.configFile."kdeglobals".text = genIni {
    ...
    General = {
      ...
      Name = "Generated";
      fixed = "DejaVuSansMono,11,-1,5,50,0,0,0,0,0";
      font = "DejaVuSerif,11,-1,5,50,0,0,0,0,0";
      menuFont = "DejaVuSerif,11,-1,5,50,0,0,0,0,0";
      shadeSortColumn = true;
      smallestReadableFont = "DejaVuSerif,8,-1,5,57,0,0,0,0,0,Medium";
      toolBarFont = "DejaVuSerif,11,-1,5,50,0,0,0,0,0";
    };
    KDE = {
